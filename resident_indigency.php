...
<head>
	...
	<title>Certificate of Indigency - Paclasan E- Request</title>
</head>
<body>
													...
													<tr>
														...
														<td>
															<div class="form-button-action">
																<a type="button" data-toggle="tooltip" href="generate_indi_cert.php?id=<?= $row['id'] ?>&id_req=<?= $id?>" class="btn btn-link btn-primary" data-original-title="Generate Certificate">
