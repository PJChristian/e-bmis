...
<?php 
    ...
    $query3 = "SELECT * FROM tblpayments WHERE id_docs='$transaction'";
    $purpose = $conn->query($query3)->fetch_assoc();
...
<head>
	...
	<title>Barangay Certificate -  E-Request</title>
</head>
<body>
								...
								<div class="card-body m-5" id="printThis">
                                    ...
                                    <div class="row mt-2" style= "color:black">
                                        ...
                                        <div class="col-md-9" style= "color:black">
                                            ...
                                            <div class="text-center">
                                                <h1 class="mt-4 fw-bold mb-3">CERTIFICATION/ CLEARANCE</h1>
                                            </div>
                                            <h3 class="mt-5">TO WHOM IT MAY CONCERN:</h3>
                                            <h3 class="mt-3" style="text-indent: 40px;">This is to certify that <span class="fw-bold" style="font-size:20px"><?= ucwords($resident['firstname'].' '.$resident['middlename'].' '.$resident['lastname']) ?></span>, of legal age, <?= $resident['civilstatus'] ?>, is a bonifide resident of this
                                            Barangay and known to be a person of good moral character:
                                            <h3 class="mt-3" style="text-indent: 40px;">Certify further that as per records filed in this office, subject person has NO derogatory record as of date issued;</h3>
                                            <h3 class="mt-3" style="text-indent: 40px;">This certification/ clearance is hereby issued upon request of the above subject person in connection to his/her application for:</h3>
                                            <h3 class="mt-3" style="text-indent: 100px;"> <input type="checkbox" id="GoodMoral"> Good Moral</h3>
                                            <h3 class="mt-3" style="text-indent: 100px;"> <input type="checkbox" id="LocalEmployment"> Local Employment</h3>
                                            <h3 class="mt-3" style="text-indent: 100px;"> <input type="checkbox" id="Passport/Travel"> Passport/Travel Abroad</h3>
                                            <h3 class="mt-3" style="text-indent: 100px;"> <input type="checkbox" id="ScholarshipProgram"> Scholarship Program</h3>
                                            <h3 class="mt-3" style="text-indent: 100px;"> <input type="checkbox" id="LicenseRenewal"> License Renewal (Driver's/Firearms)</h3>
                                            <h3 class="mt-3" style="text-indent: 100px;"> <input type="checkbox" id="Tricycle/MotorcycleFranchise"> Tricycle/Motorcycle Franchise</h3>
                                            <h3 class="mt-3" style="text-indent: 100px;"> <input type="checkbox" id="PoliceClearance"> Police Clearance</h3>
                                            <h3 class="mt-3" style="text-indent: 100px;"> <input type="checkbox" id="BirthCertificate"> Birth Certificate</h3>
                                            ...
                                            <h4 class="mt-5" style ="text-indent: 40px;">Given this <span class="fw-bold" style="font-size:20px"><?= date('d') ?></span>th day of <?=date("F Y")?>, at <span style="font-size:18px"><?= ucwords($brgy) ?>, <?= ucwords($town) ?>, <?= ucwords($province) ?></span>. 
                                        ...
                                        <div class="col-md-12 d-flex flex-wrap justify-content-end">
                                            ...
                                            <h4 class="mb-0 mt-5"><i></i>_________________________</h4>
                                                ...
                                                <h4 class="mb-0 mt-5"><i></i>__________________________</h4>
                                        ...
                                        <div class="col-md-10 mb-4 mt-5">
                                            ...
                                            <h4 class="mt-2"><i>ISSUED On</i>: <span class="fw-bold"><?= date('F d, Y') ?></span></h4>
                                            <h4 class="mt-2 "><i>ISSUED At  </i>   :   <span class="fw-bold" style="text">   <?= ucwords($brgy.','.$town.','.$province) ?> </span></h4>

                                            <p class="ml-2"><i>(*Note: Not valid without official receipt & official seal)</i></p>
                                                    </div> 
							</div>
						</div>
					</div>
                            ...
                            <form method="POST" action="model/save_pment.php" >
                                ...
                                <div class="form-group">
									...
									<select class="form-control" name="purpose" id="option-purpose" required>
                                        ...
                                        <option value="Passport/Travel"> Passport/Travel Abroad </option>
                                        <option value="Scholarship Program"> Scholarship Program </option>
                                        <option value="License Renewal"> License Renewal (Driver's/Firearms) </option>
                                        <option value="Tricycle/Motorcycle Franchise"> Tricycle/Motorcycle Franchise </option>
