													...
													<tr>
														...
														<td>
															<div class="form-button-action">
																<a type="button" data-toggle="tooltip" href="generate_brgy_cert.php?id=<?= $row['id'] ?>&id_req=<?= $id?>" class="btn btn-link btn-primary" data-original-title="Generate Certificate">
